"main";let postcss;_bd3‍.w('postcss',[["default",function(v){postcss=v}]]);let valueParser;_bd3‍.w('postcss-value-parser',[["default",function(v){valueParser=v}]]);let flatMap;_bd3‍.w('lodash',[["flatMap",function(v){flatMap=v}]]);
...
_bd3‍.d(postcss.plugin('postcss-font-family-system-ui', () => {
  return (root) => {
    root.walk(transform())
  }
}));
