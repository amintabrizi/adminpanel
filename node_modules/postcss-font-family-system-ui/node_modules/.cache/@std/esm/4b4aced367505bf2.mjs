"main";let postcss;_675‍.w('postcss',[["default",function(v){postcss=v}]]);let valueParser;_675‍.w('postcss-value-parser',[["default",function(v){valueParser=v}]]);let flatMap;_675‍.w('lodash',[["flatMap",function(v){flatMap=v}]]);
...
_675‍.d(postcss.plugin('postcss-font-family-system-ui', () => {
  return (root) => {
    root.walk(transform())
  }
}));
